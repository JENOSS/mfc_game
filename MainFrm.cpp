...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	m_wndSplitter.CreateView(0, 0, RUNTIME_CLASS(Ctestmfc3View), CSize(1600, 300), pContext);
	m_wndSplitter.CreateView(0, 1, RUNTIME_CLASS(CTextOutDlg), CSize(50, 300), pContext);

	//m_wndFixedSplitter.CreateStatic(this, 1, 2);
	//m_wndFixedSplitter.CreateView(0, 0, RUNTIME_CLASS(Ctestmfc3View), CSize(1700, 700), pContext);
	//m_wndFixedSplitter.CreateView(0, 1, RUNTIME_CLASS(CTextOutDlg), CSize(50, 700), pContext);
	return TRUE;
